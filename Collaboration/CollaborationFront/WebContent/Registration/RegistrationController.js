/*(function () {
    ...
    RegisterController.$inject = ['RegistrationService', '$location', '$rootScope', 'FlashService'];
    function RegisterController(RegistrationService, $location, $rootScope, FlashService) {
        var vm = this;
...
app.controller('RegistrationController', ['$scope', '$http',   'RegistrationService', 
                         '$location', '$rootScope',
