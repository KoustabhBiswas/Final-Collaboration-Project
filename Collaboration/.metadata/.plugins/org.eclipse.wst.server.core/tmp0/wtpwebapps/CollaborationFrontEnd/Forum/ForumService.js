app.service('ForumService',[
	         ...
	         function($http, $q, $rootScope){
	        	 ...
	        	 this.getMyForum = function(buId){
						var defer = $q.defer();
						$http.get('http://localhost:9855/Collaboration_Back/myForum/' + buId).then(function(response){
							defer.resolve(response.data);
						},function(error){
							defer.reject();
						});
	        	 ...
	        	 this.setForumById = function(id){
						var defer = $q.defer();
						$http.get('http://localhost:9855/Collaboration_Back/oneforum/' + id).then(function(response){
							defer.resolve(response.data);
						},function(error){
							defer.reject();
						});
	        	 ...
	        	 this.deleteBlog  = function(buId){
						var defer = $q.defer();
						$http.post('http://localhost:9855/Collaboration_Back/deleteforum/' + buId).then(function(response){
							defer.resolve(response.data);
						},function(error){
							defer.reject();
						});
	        	 ...
	        	 this.approveBlog = function(id){
						var defer = $q.defer();
						$http.post('http://localhost:9855/Collaboration_Back/approveforum/' + id).then(function(response){
							defer.resolve(response.data);
						},
						function(error){
							defer.reject();
